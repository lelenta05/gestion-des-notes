...
class AssistantController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('assistant.index',compact('users'));
    }

    public function create()
    {
        $roles =Role::all();
        return view('assistant.create',compact('roles'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('assistant.dashboard')->with('success','Utilisateur créé avec succès !');
    }
    ...
    public function edit ($id)
    {
        ...
        $roles=Role::all();
        return view('assistant.edit',compact(['user','roles']));
    }
    ...
    public function update(Request $request ,  $id)
    {
        ...
        return redirect()->route('assistant.dashboard')->with('success','Utilisateur a été mise à jour avec succès !');
    }
    ...
    public function delete( $id)
    {
        $user=User::findorFail($id);
        $user->delete();
        return redirect()->route('assistant.dashboard')->with('success','Utilisateur a été supprime avec succès !');
